...
// // Set the Blockfrost API endpoint
// const apiUrl = 'https://cardano-preprod.blockfrost.io/api/v0';

// // Set your Blockfrost API key
// const apiKey = 'preprodWM7tWLXV1F1xyDszN6Nxn8MhKtewv0Mi';

// // Set the address you want to retrieve information for
// const address = 'addr_test1qpr2lgw0sx80ca2ky7c0drtvvhdgr56r98g7xghrck0lx6ycmv0lucrznjzrux6z3vhkfvd7a6fm3rjn9rxmgr4mznssgp7yml';

// // Set the API endpoint you want to call
// const endpoint = `/addresses/${address}`;

// // Set the request headers, including your API key as an authorization header
// const headers = {
...
// axios.get(apiUrl + endpoint, { headers: headers })
//   .then(response => {
